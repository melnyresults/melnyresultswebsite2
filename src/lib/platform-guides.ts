  ...
  google_analytics: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Set up a project for OAuth credentials',
        url: 'https://console.cloud.google.com/',
        substeps: [
      ...
      {
        title: 'Enable Analytics Data API',
        description: 'Activate the Google Analytics Data API',
      ...
      },
      {
        ...
        description: 'Set up OAuth 2.0 credentials',
        url: 'https://console.cloud.google.com/apis/credentials',
        substeps: [
          'Click "Create Credentials" > "OAuth client ID"',
      ...
      {
        title: 'Generate Access Token',
        description: 'Use OAuth Playground to get your access token',
        url: 'https://developers.google.com/oauthplayground/',
        substeps: [
          'Click the gear icon (Settings) in top right',
          'Check "Use your own OAuth credentials"',
          'Enter your Client ID and Client Secret',
          'In Step 1, search for "Google Analytics Data API v1"',
    ...
    notes: [
      ...
      'Access tokens expire after 1 hour - you will need to regenerate them',
      'For production use, implement refresh token flow',
      'Make sure the Google account used has Viewer access to the Analytics property',
    ],
  },
