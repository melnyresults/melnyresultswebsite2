  ...
  google_analytics: {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        description: 'Your Google OAuth 2.0 access token with Analytics read permissions',
      },
    ],
    steps: [
      {
      ...
      {
        title: 'Step 7: Generate Your Access Token',
        description: 'Use Google OAuth Playground to create an access token with the correct permissions',
        url: 'https://developers.google.com/oauthplayground/',
        substeps: [
          ...
          'You will see an "Access token" appear in the response',
          'IMPORTANT: Copy the "Access token" value (NOT the refresh token)',
          'This is the token you will paste into the connection form',
        ],
      },
      {
        ...
        substeps: [
          ...
          'Paste your Access Token (from Step 7) in the "OAuth Access Token" field',
          'Double-check both values are correct',
    ...
    notes: [
      'Access tokens expire after 1 hour - you will need to regenerate them by repeating Step 7',
      ...
      'For production use, consider implementing refresh token flow for automatic token renewal',
      'Keep your Client ID, Client Secret, and Access Token secure and never share them publicly',
